...
par.h_a = 9.318e-09;  free.h_a   = 1;   units.h_a = '1/d^2';      label.h_a = 'Weibull aging acceleration'; 
...
par.f_Tab = 1.0813;   free.f_Tab = 1;   units.f_Tab = '-';        label.f_Tab = 'scaled functional response for Tab data'; 
par.f_Tabj = 1.1168;  free.f_Tabj = 1;   units.f_Tabj = '-';       label.f_Tabj = 'scaled functional response for Tabj data'; 
par.f_tL = 0.67492;   free.f_tL  = 1;   units.f_tL = '-';         label.f_tL = 'scaled functional response for tL data'; 
