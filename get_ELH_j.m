...
function dELH  = get_ELH_j(t, ELH, v, g, E_m, L_m, p_Am, kap, k_J, E_Hb, E_Hj, tf, tTC)
...
function [value,isterminal,direction] = event_bj(t, ELH, v, g, E_m, L_m, p_Am, kap, k_J, E_Hb, E_Hj, f, tTC)
