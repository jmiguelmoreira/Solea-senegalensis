...
metaData.data_0     = {'ah';'ab';'aj';'ap';'am';'L0';'Lh';'Lb';'Lj';'Lp';'Li';'Wd0';'Wdh';'Wdb';'Wdj';'Wwp';'Wwi';'Ri';'E0'}; % zero-variate data labels: http://www.debtheory.org/wiki/index.php?title=Zero-variate_data
metaData.data_1     = {'T-ah';'T-aj';'t-L_T';'t-Wd_f';'t-Ww';'L-Ww';'L-Wd'}; % uni-variate data labels:  http://www.debtheory.org/wiki/index.php?title=Univariate_data 
