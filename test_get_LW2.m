...
% testing; simple version with get_EL_j (no maturity tracked because f constant)
...
% assume eggs from aquaculture, Manchado data f = f_Man
 ...
 [U_H, aUL] = ode45(@dget_aul, [0; U_Hh; U_Hb], [0 U_E0 1e-10], [], kap, v, k_J, g, L_m);
  ...
  E_b = aUL(3,2) * p_Am;             % J, energy in reserves at birth
...
%    tT = temp.Taj; % special time-temp vector for Manchado data
  ...
  [t, EL, te, ye, ie] = ode45(@get_EL_j, linspace(time(1),time(end),1e3), EL_h, options, v, g, E_m, L_m, p_Am, kap, k_J, lb*L_m, lj*L_m, f_Man, tTC); % ELH: {J/cm^3, cm}, with {[E], L, H}
...
f_RibeEngr = 1;
 ...
 [t, EL, te, ye, ie] = ode23(@get_EL_j, [ tL2(:,1)], EL_b, options, v, g, E_m, L_m, p_Am, kap, k_J, lb*L_m, lj*L_m, f_RibeEngr, TC_tL2); % ELH: {J/cm^3, cm}, with {[E], L, H}
%   EL(1,:) = [];
  ELw2 = EL(:,2) / del_M;
...
function dEL  = get_EL_j(t, EL, v, g, E_m, L_m, p_Am, kap, k_J, L_b, L_j, f, tTC)
...
function [value,isterminal,direction] = event_bj(t, EL, v, g, ~, L_m, p_Am, kap, k_J, L_b, L_j, f, tT)
